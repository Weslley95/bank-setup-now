...
<body class="text-center text-white bg-info container-fluid">

    <div class="mt-4">
        <a class="btn btn-primary btn-sm" href="/dash" role="button">Dashboard</a>
    </div>

    <div class="mx-auto flex-column">
        <div class="text-center mb-5 mt-4">
            <img src="<?php echo e(asset('bank_setup_now.png')); ?>" class="rounded" alt="..." style="width: 25%;">
        </div>
...
</html><?php /**PATH /Users/weslley/Dev/data-controllers/resources/views/home.blade.php ENDPATH**/ ?>