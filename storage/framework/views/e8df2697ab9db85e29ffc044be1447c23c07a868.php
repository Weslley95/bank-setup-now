...
<!-- usuário atual -->
<div class="shadow-sm w-25 p-1 mb-2 bg-info rounded">
    <b>
        Conta atual
    </b>
</div>
...
<!-- Transação recebida -->
<div class="shadow-sm w-25 p-1 mb-2 bg-success rounded">
    <b>
        Transação recebida
    </b>
</div>
...
<!-- Transação efetuada -->
<div class="shadow-sm w-25 p-1 mb-2 bg-danger rounded">
    <b>
        Transação realizada
    </b>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\data-controllers\resources\views/contas/historic.blade.php ENDPATH**/ ?>