...
<form method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input value="autoregistro" name="metodo" class="form-control" id="metodo" style="display:none;">
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/weslley/Dev/data-controllers/resources/views/clientes/autoregistro.blade.php ENDPATH**/ ?>