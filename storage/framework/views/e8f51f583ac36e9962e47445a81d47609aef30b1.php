...
<div class="card p-1">
    <div class="card-header">
        ...
        <div class="form-group mb-2" style="float:right">
            <a href="/dash" class="btn btn-danger btn-sm" title="Novo usuário">Volta</a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\data-controllers\resources\views/contas/transation.blade.php ENDPATH**/ ?>